...
class YOLODetector:
    def __init__(self, model_path, classes_path):
        ...
        try:
            ...
            logs.add_log(f"Model {model_path} initialized. {len(self.class_names)} classes loaded.", logs.LogLevel.INFO)
        except Exception as e:
            logs.add_log(f"Failed to initialize YOLODetector: {e}", logs.LogLevel.ERROR)
            self.session = None
